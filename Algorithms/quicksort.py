...
def partition(heightList,first,last):
   ...
   while not isCompleted:
       ...
       if end < border:
           ...
           #Before swaps
           pygame.draw.rect(window, red, (xList[border],500-heightList[border],w,heightList[border]), 0)
           pygame.draw.rect(window, red, (xList[end],500-heightList[end],w,heightList[end]), 0)
           update_draw()
           buffer()
   ...
   #it swaps again
   pygame.draw.rect(window, red, (xList[first],500-heightList[first],w,heightList[first]), 0)
   pygame.draw.rect(window, red, (xList[end],500-heightList[end],w,heightList[end]), 0)
   update_draw()
   buffer()
